            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <div className="text-2xl font-bold mb-4">
                  ...
                  <span className="text-gray-300">Snipe</span>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-500">
                  <li>
                    <a href="/ai-snipers" className="hover:text-white transition-colors">
                      AI Snipers
                    </a>
                  </li>
                  <li>
                    <a href="/copy-trade" className="hover:text-white transition-colors">
                      Copy Trade
                    </a>
                  </li>
                  <li>
                    <a href="/trader-lens" className="hover:text-white transition-colors">
                      Trader Lens
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-500">
                  ...
                  <li>
                    <a href="/new-pairs" className="hover:text-white transition-colors">
                      New Pairs
                    </a>
                  </li>
                  <li>
                    <a href="/meme-vision" className="hover:text-white transition-colors">
                      Meme Vision
                    </a>
                  </li>
                </ul>
